 ...
 * @return
 */
function Participant(name, ismaster) {
	this.name = name;
	/*
	...
	*/
	...
	function createChildElt(name){
		if(ismaster){
			
			var tableBody = $('#master-div table tbody');
	...
	function onVideoEltClick(event){
		console.log("event clicked ");
		console.log("video click");
		if(center_sel !== $(this)){
			console.log("video mismatch");
			if(!$(this).attr('src')){
				center_vElt.attr('src',$(this).find('Source').attr('src'));
			}else 
				center_vElt.attr('src',$(this).attr('src'));
			center_sel = $(this);
		}else {
		}
	}
